...
function(){a(this).data("tcl").start()};a.fn.tinycarousel_stop=function(){a(this).data("tcl").stop()};a.fn.tinycarousel_move=function(c,b){a(this).data("tcl").move(c,!b)};a.fn.tinycarousel_reload=function(){a(this).data("tcl").reload()};a.fn.tinycarousel_prepend=function(){a(this).data("tcl").prepend()}})(jQuery);